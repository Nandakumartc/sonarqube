...
public class RootTest {
  ...
  @Test
  public void system_administrator_is_flagged_as_root_when_he_enables_organization_feature() {
  ...
  private void enableOrganizationFeature() {
    orchestrator.getServer().post("api/organizations/enable_feature", Collections.emptyMap());
  }
